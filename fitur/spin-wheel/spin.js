...
function spin() {
  ...
  let availableItems = items.filter((item) => item !== previousWinner);
  let selectedItem =
...
document
  .querySelector(".inputArea textarea")
  .addEventListener("change", createWheel);
...
ScrollReveal().reveal(".head, .inputArea .btn", {
  origin: "bottom",
});
