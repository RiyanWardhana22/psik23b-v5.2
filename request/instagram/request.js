...
// Form Section
document.getElementById("form-ig").addEventListener("submit", function (e) {
  e.preventDefault();
  ...
  fetch(
    "https://script.google.com/macros/s/AKfycbwYTdAmqMwAqXt1ualyP8MpRbEU9GDISQNtMpzJCnljIUu-xNtv7pp9ohR6IRgRwlW6/exec",
    {
      method: "POST",
      body: formData,
    }
    ...
    .then((result) => {
      alert(result);
      document.getElementById("form-ig").reset();
    })
